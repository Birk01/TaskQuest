...
import { Task, TaskType, TaskPriority, TaskCategory } from '../types';
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <motion.button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl font-medium shadow-lg shadow-purple-500/20"
        >
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <div className="flex bg-slate-800 border border-slate-700 rounded-xl overflow-hidden">
          {(['all', 'single', 'recurring', 'longterm'] as const).map((t) => (
            <button
              key={t}
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="w-full py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl font-medium shadow-lg shadow-purple-500/20"
                >
                  Создать задачу
                </motion.button>
              </form>
